...
public class FabbricaDiComandiFisarmonicaTest {
	...
	// creaComando("aiuto") crea un comando di classe ComandoAiuto
	@Test
	public void testCreaComando_ComandoAiutoGetClass() {
		assertSame(ComandoAiuto.class, this.factory.creaComando("aiuto").getClass());
	}

	@Test
	public void testCreaComando_ComandoFineGetClass() {
		assertSame(ComandoFine.class, this.factory.creaComando("fine").getClass());
	}

	@Test
	public void testCreaComando_ComandoGuardaGetClass() {
		assertSame(ComandoGuarda.class, this.factory.creaComando("guarda").getClass());
	}
	
	@Test
	public void testCreaComando_ComandoPosaGetClass() {
		assertSame(ComandoPosa.class, this.factory.creaComando("posa").getClass());
	}
	
	@Test
	public void testCreaComando_ComandoPrendiGetClass() {
		assertSame(ComandoPrendi.class, this.factory.creaComando("prendi").getClass());
	}
	
	@Test
	public void testCreaComando_ComandoVaiGetClass() {
		assertSame(ComandoVai.class, this.factory.creaComando("vai").getClass());
	}
	
	@Test
	public void testCreaComando_nonValido_getClass() {
		assertSame(ComandoNonValido.class, this.factory.creaComando(null).getClass());
	}
}
